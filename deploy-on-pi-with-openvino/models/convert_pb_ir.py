#!/usr/bin/env python3
# originally mo_tf.py which comes with the installation of the OPENVINO Toolkit
# NOTE: You need the full version of OPENVINO to get this file. The Raspberry Pi
